...
var NeutrinoApi = /** @class */ (function () {
    ...
    NeutrinoApi.prototype.addBuyBondOrder = function (amount, price, seed) {
        return __awaiter(this, void 0, void 0, function () {
            var auctionData, firstOrder, prevOrder, nextOrder, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        auctionData = _a.sent();
                        firstOrder = auctionData[OrderKeys_1.OrderKeys.FirstOrderKey];
                        prevOrder = "";
                        if (firstOrder !== undefined && firstOrder.value != "") {
                            nextOrder = firstOrder.value;
                            while (nextOrder !== undefined && nextOrder != "") {
                                if (price > auctionData[OrderKeys_1.OrderKeys.OrderPriceKey + nextOrder].value) {
                                    break;
                                }
                                prevOrder = nextOrder;
                                nextOrder = auctionData[OrderKeys_1.OrderKeys.NextOrderKey + prevOrder].value;
                            }
                        }
                        tx = waves_transactions_1.invokeScript({
    ...
    NeutrinoApi.PAULI = Math.pow(10, 6);
    return NeutrinoApi;
}());
