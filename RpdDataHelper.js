...
var RpdDataHelper = /** @class */ (function () {
    function RpdDataHelper() {
    }
    RpdDataHelper.setData = function (neutrinoSeed, rpdSeed, neutrinoAssetId, nodeUrl, chainId, removeMultisig) {
        if (removeMultisig === void 0) { removeMultisig = false; }
        return __awaiter(this, void 0, void 0, function () {
            var neutrinoDataTx, rpdDataTx;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        rpdDataTx = waves_transactions_1.data({
                            data: [
                                { key: 'neutrino_contract', value: (new seedUtils_1.Seed(neutrinoSeed, chainId)).address },
                            ],
                            fee: 500000
                        }, rpdSeed);
    ...
    return RpdDataHelper;
}());
exports.RpdDataHelper = RpdDataHelper;
